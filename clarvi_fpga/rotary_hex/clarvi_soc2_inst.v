	clarvi_soc2 u0 (
		...
		.rotaryctl2_0_rotary_event_rotary_ccw      (<connected-to-rotaryctl2_0_rotary_event_rotary_ccw>),      //   rotaryctl2_0_rotary_event.rotary_ccw
		.rotaryctl2_0_rotary_event_rotary_cw       (<connected-to-rotaryctl2_0_rotary_event_rotary_cw>),       //                            .rotary_cw
		.rotaryctl2_0_rotary_in_rotary_in          (<connected-to-rotaryctl2_0_rotary_in_rotary_in>),          //      rotaryctl2_0_rotary_in.rotary_in
		.rotaryctl2_1_rotary_event_rotary_ccw      (<connected-to-rotaryctl2_1_rotary_event_rotary_ccw>),      //   rotaryctl2_1_rotary_event.rotary_ccw
		.rotaryctl2_1_rotary_event_rotary_cw       (<connected-to-rotaryctl2_1_rotary_event_rotary_cw>),       //                            .rotary_cw
		.rotaryctl2_1_rotary_in_rotary_in          (<connected-to-rotaryctl2_1_rotary_in_rotary_in>),          //      rotaryctl2_1_rotary_in.rotary_in
